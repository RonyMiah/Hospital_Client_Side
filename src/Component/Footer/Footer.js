...
<footer className="text-center text-lg-start  text-muted" style={{backgroundColor: '#EBF2F2'}}>
      ...
      <div className="row mt-3">
        ...
        <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 className="text-uppercase fw-bold mb-4">
            <img src='https://i.ibb.co/BZrPr4x/logo.png' alt="" width="100%"/>
          </h6>
          <p>
        ...
        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          {/*   Links  */}
          <h6 className="text-uppercase fw-bold fs-4  mb-4">
            Useful links
          </h6>
          <p>
  ...
  <div className="text-center p-4" style={{ "backgroundColor": "rgba(0, 0, 0, 0.05)"}}>
    © 2021 Copyright: 
    <Link to="/" className="text-reset fw-bold"> BD Hospital </Link>
  </div>
  {/*  Copyright  */}
</footer>
//   Footer -->
